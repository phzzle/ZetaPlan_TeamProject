    ...
    <div>
      ...
      <section className='abroad-content-box'>
        ...
        <ul className='abroad-desc-list'>
          ...
          <li>
            · 타당성조사 비용 지원을 통해 우리기업의 해외사업 참여에 따른 경제적 부담완화 및 ODA 등 대외원조 사업과의 연계효과 창출
          </li>
        </ul>
        <h6 className="abroad-sub-title">
          지원 금액
      ...
      <section className='abroad-content-box'>
        ...
        <ul className="abroad-desc-list">
          ...
          <li>
            · 국내외 전시회 사이버 박람회 개최 <br/>
            – 고화질 영상장비, 브로슈어, 샘플 등을 활용한 온ㆍ오프라인 홍보 <br/>
            – 1:1 바이어 상담(화상회의 포함) 및 통번역 지원 <br/>
            – 전자카탈로그, 인터뷰 영상, 사이버 부스 등 지원
          </li>
          <li>
            · 온라인 수출마케팅 지원 <br/>
            – 해외 B2B 마켓플레이스 내 제품 등록 및 홍보 <br/>
            – 신규 프로젝트 발굴 및 바이어 매칭을 통한 상시 화상상담 지원 <br/>
            – 해외 현지 바이어 초청 화상상담회 및 간담회 참여 지원 (출장비 업체 부담) <br/>
            – 기술 /제품 홍보를 위한 전자홍보물 제작 (현지어) <br/>
            – 해외진출 전략 컨설팅 및 해외진출지원 프로그램 알선, 온라인 수출마케팅 교육 <br/>
