...
const IndustrySupport1 = () => {
  return (
    <div id='IndustrySupport1'>
      ...
      <p className='industry-support1-des'>기술금융의 지원방식은 TCB 전문기관을 통한 기술력 등급의 평가 대출과 기업이 보유한 지적재산권의 가치를 평가하여 지원하는 <strong>특허권담보대출</strong>,<br />우수 지식재산권을 보유한 기업의 <strong>IP사업화 보증</strong>, 지적재산권의 판매 후 자금을 조달하고 독점적인 사용권한을 갖는 방식인<strong>세일앤드라이센스백(Sale & License back)을 통한 지적재산권 유동화 방식</strong>과,<br />보유한 우수한 기술력과 지적재산권의 평가를 통한 <strong>IP우수기업 투자하는 형태</strong> 등 크게 <strong>4가지</strong> 형태로 나누어진다.</p>
    </div>
  );
};
