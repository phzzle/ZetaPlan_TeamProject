...
const IndustrySupport1 = () => {
  return (
    <div id='IndustrySupport1'>
      <h4 className='company-road-part'>기술금융의 목적</h4>
      <p className='industry-support1-des'>기술금융은 기업의 재무정보 이외에 기술정보를 추가로 고려함으로써 신용도 판단 예측 의 정확성을 높이고, 담보력이 부족한 벤처창업기업을 대상으로 기술평가 전문기관의 기 술성∙사업성 평가를 통해 금융기관의 사업화 자금 대출 및 펀드운용사의 투자를 지원함으로써, 중소기업 및 벤처 &#183; 창업기업의 성장을 지원하고 개발기술의 사업화를 추진하는 데 목적이 있다.</p>
      <div className="industry-support-img"><img src="/img/Industry/IndustrySupport/IndustrySupport1.png" alt="기술금융의 단계" /></div>
