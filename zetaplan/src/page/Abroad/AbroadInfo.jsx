...
const AbroadInfo = ({title, sub}) => {
  ...
  return (
    <div>
      ...
      <div id='SubInner'>
        <h2 className='detail-title'>해외진출 사업</h2>
        <div className='abroad-info'>
          ...
          <p className='abroad-desc'>· 국내에는 한국발명진흥회, 농업기술실용화재단, 중소기업청 해외민간네트워크 등을 통해 한국과 해외간의 공식적인 기술이전사업을 진행</p>
          <h6 className='abroad-sub-title'>글로벌 투자유치</h6>
          <p className='abroad-desc'>글로벌 시장 진출 및 해외투자유치를 희망하는 기업들에게 기술평가 및 IR 컨설팅 지원 등 투자유치 전문서비스 지원</p>
          <p className='abroad-desc'>기업의 업종 및 성장단계에 맞는 투자자 정보 제공, 투자유치 설명회 개최 및 관심 투자자 매칭 지원 등 투자유치 정보제공</p>
          <h6 className='abroad-sub-title'>전문분야 강점</h6>
        </div>
        <div className='abroad-network'>
          <h4 className='abroad-title'>제타플랜 해외네트워크</h4>
          {
