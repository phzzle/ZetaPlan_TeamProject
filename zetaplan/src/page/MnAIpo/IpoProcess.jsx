      ...
      <div id="SubInner">
        <section className="mnaipo-ipoprocess-section1">
          <div className="mnaipo-ipoprocess-title-container">
            <h2 className="mnaipo-ipoprocess-title">IPO 컨설팅 과정</h2>
            <div className="mnaipo-ipoprocess-title-line"></div>
          </div>
        </section>
        <section className="mnaipo-ipoprocess-section">
          <div className="mnaipo-ipoprocess-section-img"></div>
        </section>
        <div className="flex">
          <section className="mnaipo-ipoprocess-section">
            <div>
              ...
              <ul>
                <li>기업공개 및 상장시기결정 </li>
                <li>상장준비추진팀 구성</li>
                <li>최대주주 등의 지분변동 사전점검</li>
                <li>회계감사인의 선정 및 감리 </li>
                <li>대표 주관회사의 선정</li>
                <li>정관정비</li>
                <li>명의개서대행계약체결</li>
                <li>우리사주조합결정</li>
                <li>상장을 위한 이사회 또는 주총 결의</li>
                <li>최대주주 등의 소유주식등 보호 예수</li>
              </ul>
            </div>
          </section>
          <section className="mnaipo-ipoprocess-section">
            <div>
              ...
              <ul>
                ...
                <li>상장예비심사 분산 요건</li>
                <li>상장예비심사 재무 요건</li>
                <li>상장예비심사 안정성 및 건전성 요건</li>
                <li>상장예비심사 실질적 심사 기준</li>
                <li>상장위원회 심의</li>
                <li>상장예비심사 결과 통지</li>
              </ul>
            </div>
          ...
          <section className="mnaipo-ipoprocess-section">
            <div>
              ...
              <ul>
                <li>유가증권신고서 제출</li>
                <li>예비 투자 설명서 제출</li>
                <li>정정신고서 제출 및 유가증권신고서 효력발생</li>
                <li>투자 설명서 비치, 교부</li>
                <li>수요예측 및 공모가격 결정</li>
                <li>청약,배정 및 납입</li>
              </ul>
            </div>
          </section>
