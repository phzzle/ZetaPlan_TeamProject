                  ...
                  <th>
                    <dl>
                      ...
                      <dd>
                        ...
                        외국에서 주식을 발행하거나 외국에서 발행한 해외전환사채, 해외신주인수권부사채, 기타 주식과
                        관련된 증권 또는 증서의 권리행사로 발행하는 의결권 없는 주식은 발행한도의 계산에 산입되지
                        않습니다.
                      </dd>
                ...
                <tr>
                  ...
                  <td>
                    <dl>
                      ...
                      <dd>
                        상장주식은 대주주 등을 제외하고 주식양도에 따른 양도소득세를 부과하지 않고 있기 때문에 상장을
                        위해 모집하거나 유가증권시장을 통하여 양도하는 경우에는 양도소득세가 면제됩니다. 그러나
                        비상장주식은 양도차익의 20%(중소기업의 경우 10%, 중소기업 이외의 법인의 주식을 소유한 대주주로서
                        1년 미만 보유시 30%)를 세금으로 납부하여야 합니다.
                      </dd>
                      <dt> 상속 및 증여재산의 시가평가 (상속및증여세법 제63조 및 동법시행령 제53조)</dt>
                      <dd>
                        비상장법인이 발행한 주식을 상속 또는 증여할 경우 상속세 및 증여세법에서 정한 산식으로 평가하나,
                        상장법인이 발행한 주식을 상속 또는 증여할 경우 평가기준일 전․후 각각 2개월간 최종시세의
                        평균액으로 평가합니다.
                      </dd>
